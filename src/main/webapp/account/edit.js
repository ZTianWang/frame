	...
	exports.init = function() {
		...
		KU.send({
			...
			success : function(data) {
				...
				accountObj.content&&contentEditor.addListener("ready", function () {
					contentEditor.setContent(accountObj.content);
				});
		...
		$accountForm.validForm(rules, function() {
			...
			var formJson = $accountForm.serializeJson(['password_again']);
